...
class RecuperacionPasswordMail extends Mailable
{
    ...
    {
        return new Envelope(
            subject: 'CarZone — Recuperación de contraseña'
        );
    }
        ...
        <table width='600' cellpadding='0' cellspacing='0' style='background:#fff;border-radius:12px;overflow:hidden;max-width:600px;width:100%;'>
            ...
            <tr>
                <td style='background:#1a1a1a;padding:32px;text-align:center;'>
                    <h1 style='margin:0;color:#fff;font-size:28px;letter-spacing:4px;font-weight:700;'>
                        CAR<span style='color:#f59e0b;'>ZONE</span>
                    </h1>
            ...
            <tr>
                <td style='background:#f9f9f9;padding:24px 40px;border-top:1px solid #eee;text-align:center;'>
                    ...
                    <p style='margin:8px 0 0;font-size:12px;color:#aaa;'>Si no solicitaste esto, no es necesario que hagas nada.</p>
                </td>
            </tr>
