...
class FinanciacionRespondidaMail extends Mailable
{
    ...
    {
        $esAceptada = $this->financiacion->estado === 'aceptada';

        return new Envelope(
            subject: $esAceptada
                ? 'Tu financiación en CarZone ha sido aceptada'
                : 'Tu financiación en CarZone ha sido denegada'
        );
    }
    ...
    private function buildHtml(): string
    {
        ...
        // Color e información según si está aceptada o denegada
        $color = $esAceptada ? '#22c55e' : '#ef4444';
        $estadoTexto = $esAceptada ? 'Aceptada' : 'Denegada';
        $descripcion = $esAceptada
            ? 'Enhorabuena. Tu solicitud ha sido aprobada. Nos pondremos en contacto contigo para los siguientes pasos.'
            : 'Lo sentimos. Tu solicitud no ha podido ser aprobada en este momento. Puedes contactarnos para más información.';
                ...
                <td style='padding:36px 40px;'>
                    ...
                    <table width='100%' cellpadding='0' cellspacing='0' style='border-top:1px solid #eee;'>
                        ...
                        <tr style='border-top:1px solid #f0f0f0;'>
                            ...
                            <td style='padding:8px 0;font-size:14px;font-weight:600;'>{$cuota}/mes</td>
                        </tr>
                        <tr style='border-top:1px solid #f0f0f0;'>
                            <td style='padding:8px 0;color:#888;font-size:14px;'>Estado</td>
                            <td style='padding:8px 0;'>
                                <span style='background:{$color};color:#fff;padding:3px 10px;border-radius:20px;font-size:12px;font-weight:600;'>{$estadoTexto}</span>
                            </td>
                        </tr>
                    </table>
                </td>
